...
const ListItem = () => {
  ...
  const handleListItem = () => {
    ...
    axios
      .post("http://localhost:8000/", listItem, {
        headers: {
        ...
        <div className=" rounded-3xl bg-stone-50 w-1/2 p-8 flex flex-col justify-between">
          <div>
            ...
            <div className="flex flex-row gap-5 mt-2">
              <select className="cursor-pointer outline-none text-xs font-semibold rounded-xl px-3 py-1 bg-stone-200" value={category} onChange={handleCategory}>
            ...
            <textarea name="" id="" placeholder="Add a description" className="w-full border border-stone-200 bg-stone-50 h-44 mt-5 rounded-xl font-sub text-lg font-medium text-stone-500 p-4 outline-none" onChange={handleDescription}>
                    
            </textarea>
            <div className="flex justify-between mt-10">
                <select className="cursor-pointer outline-none font-sub text-xl font-bold text-stone-600 p-2 rounded-lg px-3 bg-stone-50" onChange={handleProductType}>
                ...
                <input type="text" name="" id="" placeholder="Enter Price" className="font-sub text-2xl h-fit p-3 bg-stone-50  font-bold text-blue-700 placeholder:font-normal border-b-2 border-stone-400 outline-none w-44" onChange={(e) => setPrice(e.target.value)}/>

            </div>
            <input type="text" name="" id="" placeholder="Enter Quantity" className="font-sub text-lg font-bold text-stone-600 h-fit p-3 bg-stone-50 placeholder:font-normal border-b-2 border-stone-400 outline-none w-44" onChange={(e) => setQuantity(e.target.value)}/>
          </div>
